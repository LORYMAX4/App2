...
public class SkillResourceIT {
    ...
    private static final Integer DEFAULT_ORDINE_VISUALIZZAZIONE = 1;
    private static final Integer UPDATED_ORDINE_VISUALIZZAZIONE = 2;
    ...
    public static Skill createEntity(EntityManager em) {
        Skill skill = new Skill()
            ...
            .ordineVisualizzazione(DEFAULT_ORDINE_VISUALIZZAZIONE)
    ...
    public static Skill createUpdatedEntity(EntityManager em) {
        Skill skill = new Skill()
            ...
            .ordineVisualizzazione(UPDATED_ORDINE_VISUALIZZAZIONE)
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.getDescrizione()).isEqualTo(DEFAULT_DESCRIZIONE);
        assertThat(testSkill.getOrdineVisualizzazione()).isEqualTo(DEFAULT_ORDINE_VISUALIZZAZIONE);
        assertThat(testSkill.getLivello()).isEqualTo(DEFAULT_LIVELLO);
    }
    ...
    public void getAllSkills() throws Exception {
        ...
        restSkillMockMvc.perform(get("/api/skills?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].ordineVisualizzazione").value(hasItem(DEFAULT_ORDINE_VISUALIZZAZIONE)))
    ...
    public void getSkill() throws Exception {
        ...
        restSkillMockMvc.perform(get("/api/skills/{id}", skill.getId()))
            ...
            .andExpect(jsonPath("$.ordineVisualizzazione").value(DEFAULT_ORDINE_VISUALIZZAZIONE))
    ...
    public void updateSkill() throws Exception {
        ...
        Skill testSkill = skillList.get(skillList.size() - 1);
        assertThat(testSkill.getDescrizione()).isEqualTo(UPDATED_DESCRIZIONE);
        assertThat(testSkill.getOrdineVisualizzazione()).isEqualTo(UPDATED_ORDINE_VISUALIZZAZIONE);
        assertThat(testSkill.getLivello()).isEqualTo(UPDATED_LIVELLO);
    }
